 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufpe.ines.decode.decode.artifacts.QuestionnaireInner#getElements <em>Elements</em>}</li>
 *   <li>{@link br.ufpe.ines.decode.decode.artifacts.QuestionnaireInner#getPlacementquestionnaire <em>Placementquestionnaire</em>}</li>
 * </ul>
 *
 * @see br.ufpe.ines.decode.decode.artifacts.ArtifactsPackage#getQuestionnaireInner()
 * @model
 * @generated
 */
public interface QuestionnaireInner extends AbstractArtifact, Nameable {
	 ...
	 * @see br.ufpe.ines.decode.decode.artifacts.ArtifactsPackage#getQuestionnaireInner_Elements()
	 ...
	 * It is bidirectional and its opposite is '{@link br.ufpe.ines.decode.decode.taskDescription.QuestionnaireMeasurement#getQuestionnaire <em>Questionnaire</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see br.ufpe.ines.decode.decode.artifacts.ArtifactsPackage#getQuestionnaireInner_Placementquestionnaire()
	...
	/**
	 * Sets the value of the '{@link br.ufpe.ines.decode.decode.artifacts.QuestionnaireInner#getPlacementquestionnaire <em>Placementquestionnaire</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
