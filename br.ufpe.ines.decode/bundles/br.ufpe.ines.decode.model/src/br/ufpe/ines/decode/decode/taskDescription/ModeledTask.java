 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufpe.ines.decode.decode.taskDescription.ModeledTask#getRestriction <em>Restriction</em>}</li>
 *   <li>{@link br.ufpe.ines.decode.decode.taskDescription.ModeledTask#getMeasurements <em>Measurements</em>}</li>
 *   <li>{@link br.ufpe.ines.decode.decode.taskDescription.ModeledTask#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @see br.ufpe.ines.decode.decode.taskDescription.TaskDescriptionPackage#getModeledTask()
 * @model abstract="true"
 * @generated
 */
public interface ModeledTask extends Nameable, Identifiable {
	 ...
	 * @see br.ufpe.ines.decode.decode.taskDescription.TaskDescriptionPackage#getModeledTask_Restriction()
	...
	/**
	 * Sets the value of the '{@link br.ufpe.ines.decode.decode.taskDescription.ModeledTask#getRestriction <em>Restriction</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see br.ufpe.ines.decode.decode.taskDescription.TaskDescriptionPackage#getModeledTask_Measurements()
	...
	/**
	 * Sets the value of the '{@link br.ufpe.ines.decode.decode.taskDescription.ModeledTask#getMeasurements <em>Measurements</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see br.ufpe.ines.decode.decode.taskDescription.TaskDescriptionPackage#getModeledTask_Parent()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link br.ufpe.ines.decode.decode.taskDescription.ModeledTask#getParent <em>Parent</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
