...
/**
 * This is the item provider adapter for a {@link br.ufpe.ines.decode.decode.artifacts.QuestionnaireInner} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QuestionnaireInnerItemProvider extends AbstractArtifactItemProvider {
	/**
	 ...
	 * @generated
	 */
	public QuestionnaireInnerItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addPlacementquestionnairePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_QuestionnaireInner_placementquestionnaire_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_QuestionnaireInner_placementquestionnaire_feature", "_UI_QuestionnaireInner_type"),
				 ArtifactsPackage.Literals.QUESTIONNAIRE_INNER__PLACEMENTQUESTIONNAIRE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArtifactsPackage.Literals.QUESTIONNAIRE_INNER__ELEMENTS);
		}
	...
	/**
	 * This returns QuestionnaireInner.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/QuestionnaireInner"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(QuestionnaireInner.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArtifactsPackage.Literals.QUESTIONNAIRE_INNER__ELEMENTS,
