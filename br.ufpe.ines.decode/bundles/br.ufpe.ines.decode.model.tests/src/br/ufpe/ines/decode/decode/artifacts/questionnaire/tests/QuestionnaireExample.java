...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>questionnaire</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class QuestionnaireExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.questionnaire"));
				Block root = QuestionnaireFactory.eINSTANCE.createBlock();
