...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>measurement</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasurementExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(MeasurementPackage.eNS_URI, 
			 MeasurementPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.measurement"));
				Measurements root = MeasurementFactory.eINSTANCE.createMeasurements();
