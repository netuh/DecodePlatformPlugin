...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>artifacts</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ArtifactsPackage.eNS_URI, 
			 ArtifactsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				...
				ProvidedArtifact root = ArtifactsFactory.eINSTANCE.createProvidedArtifact();
