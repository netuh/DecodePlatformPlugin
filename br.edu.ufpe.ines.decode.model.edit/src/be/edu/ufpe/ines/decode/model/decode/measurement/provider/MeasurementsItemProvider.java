...
/**
 * This is the item provider adapter for a {@link be.edu.ufpe.ines.decode.model.decode.measurement.Measurements} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasurementsItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MeasurementPackage.Literals.MEASUREMENTS__MEASUREMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MeasurementPackage.Literals.MEASUREMENTS__MEASUREMENTS,
				 MeasurementFactory.eINSTANCE.createSurvey()));

		newChildDescriptors.add
			(createChildParameter
				(MeasurementPackage.Literals.MEASUREMENTS__MEASUREMENTS,
				 MeasurementFactory.eINSTANCE.createTimeOnTask()));

		newChildDescriptors.add
			(createChildParameter
				(MeasurementPackage.Literals.MEASUREMENTS__MEASUREMENTS,
				 MeasurementFactory.eINSTANCE.createObservingProvidedArtifact()));

		newChildDescriptors.add
			(createChildParameter
				(MeasurementPackage.Literals.MEASUREMENTS__MEASUREMENTS,
				 MeasurementFactory.eINSTANCE.createObservingProducedArtifact()));

		newChildDescriptors.add
			(createChildParameter
				(MeasurementPackage.Literals.MEASUREMENTS__MEASUREMENTS,
				 MeasurementFactory.eINSTANCE.createObservingAllArtifacts()));
	}
