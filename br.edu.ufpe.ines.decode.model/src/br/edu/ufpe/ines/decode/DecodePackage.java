 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see br.edu.ufpe.ines.decode.DecodeFactory
 * @model kind="package"
 * @generated
 */
public interface DecodePackage extends EPackage {
	 ...
	 * @generated
	 */
	DecodePackage eINSTANCE = br.edu.ufpe.ines.decode.impl.DecodePackageImpl.init();

	/**
	 * The meta object id for the '{@link br.edu.ufpe.ines.decode.impl.CodingExperimentImpl <em>Coding Experiment</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see br.edu.ufpe.ines.decode.impl.CodingExperimentImpl
	 * @see br.edu.ufpe.ines.decode.impl.DecodePackageImpl#getCodingExperiment()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link br.edu.ufpe.ines.decode.CodingExperiment <em>Coding Experiment</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Coding Experiment</em>'.
	 * @see br.edu.ufpe.ines.decode.CodingExperiment
	 * @generated
	 */
	EClass getCodingExperiment();

	/**
	 * Returns the meta object for the containment reference '{@link br.edu.ufpe.ines.decode.CodingExperiment#getTask <em>Task</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Task</em>'.
	 * @see br.edu.ufpe.ines.decode.CodingExperiment#getTask()
	 ...
	 * @see br.edu.ufpe.ines.decode.CodingExperiment#getProvidedArtefacts()
	 * @see #getCodingExperiment()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link br.edu.ufpe.ines.decode.impl.CodingExperimentImpl <em>Coding Experiment</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see br.edu.ufpe.ines.decode.impl.CodingExperimentImpl
		 * @see br.edu.ufpe.ines.decode.impl.DecodePackageImpl#getCodingExperiment()
