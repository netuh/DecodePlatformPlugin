 ...
 * </p>
 * <ul>
 *   <li>{@link br.edu.ufpe.ines.decode.measurement.ObservingProvidedArtifact#getObservedArtifact <em>Observed Artifact</em>}</li>
 * </ul>
 *
 * @see br.edu.ufpe.ines.decode.measurement.MeasurementPackage#getObservingProvidedArtifact()
 * @model
 * @generated
 */
public interface ObservingProvidedArtifact extends ObservingArtifact {
	 ...
	 * @see br.edu.ufpe.ines.decode.measurement.MeasurementPackage#getObservingProvidedArtifact_ObservedArtifact()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link br.edu.ufpe.ines.decode.measurement.ObservingProvidedArtifact#getObservedArtifact <em>Observed Artifact</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
