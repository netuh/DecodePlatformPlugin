...
import br.ufpe.ines.decode.artifacts.ProvidedArtefacts;
 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufpe.ines.decode.CodingExperiment#getTask <em>Task</em>}</li>
 *   <li>{@link br.ufpe.ines.decode.CodingExperiment#getProvidedArtefacts <em>Provided Artefacts</em>}</li>
 * </ul>
 *
 * @see br.ufpe.ines.decode.DecodePackage#getCodingExperiment()
 * @model
 * @generated
 */
public interface CodingExperiment extends Nameable, Identifiable {
	 ...
	 * @see br.ufpe.ines.decode.DecodePackage#getCodingExperiment_Task()
	...
	/**
	 * Sets the value of the '{@link br.ufpe.ines.decode.CodingExperiment#getTask <em>Task</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see br.ufpe.ines.decode.DecodePackage#getCodingExperiment_ProvidedArtefacts()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link br.ufpe.ines.decode.CodingExperiment#getProvidedArtefacts <em>Provided Artefacts</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
