...
import br.ufpe.ines.decode.DecodePackage;

import br.ufpe.ines.decode.artifacts.ArtifactsPackage;

import br.ufpe.ines.decode.artifacts.impl.ArtifactsPackageImpl;

import br.ufpe.ines.decode.aux.AuxPackage;

import br.ufpe.ines.decode.aux.impl.AuxPackageImpl;

import br.ufpe.ines.decode.impl.DecodePackageImpl;

import br.ufpe.ines.decode.taskDescription.ComposedTask;
import br.ufpe.ines.decode.taskDescription.EclipseParameter;
import br.ufpe.ines.decode.taskDescription.ExecutionDerivations;
import br.ufpe.ines.decode.taskDescription.ExperimentalTask;
import br.ufpe.ines.decode.taskDescription.GeneralParameter;
import br.ufpe.ines.decode.taskDescription.IDEParameter;
import br.ufpe.ines.decode.taskDescription.Measurement;
import br.ufpe.ines.decode.taskDescription.Measurements;
import br.ufpe.ines.decode.taskDescription.ModeledTask;
import br.ufpe.ines.decode.taskDescription.OtherParameters;
import br.ufpe.ines.decode.taskDescription.Parameter;
import br.ufpe.ines.decode.taskDescription.PenAndPaperQuestionnaire;
import br.ufpe.ines.decode.taskDescription.PlacementType;
import br.ufpe.ines.decode.taskDescription.QuestionnaireMeasurement;
import br.ufpe.ines.decode.taskDescription.Questionnairemeasure;
import br.ufpe.ines.decode.taskDescription.Random;
import br.ufpe.ines.decode.taskDescription.Sequencial;
import br.ufpe.ines.decode.taskDescription.TaskDescriptionFactory;
import br.ufpe.ines.decode.taskDescription.TaskDescriptionPackage;
import br.ufpe.ines.decode.taskDescription.TimeRestriction;
...
public class TaskDescriptionPackageImpl extends EPackageImpl implements TaskDescriptionPackage {
	 ...
	 * @see br.ufpe.ines.decode.taskDescription.TaskDescriptionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EOperation getModeledTask__GetAllParameters() {
	 ...
	 * @generated
	 */
	public EOperation getModeledTask__GetAllMeasument() {
		return modeledTaskEClass.getEOperations().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(modeledTaskEClass, MODELED_TASK___GET_ALL_PARAMETERS);
		createEOperation(modeledTaskEClass, MODELED_TASK___GET_ALL_MEASUMENT);
	...
	public void initializePackageContents() {
		...
		initEOperation(getModeledTask__GetAllParameters(), this.getParameter(), "getAllParameters", 0, -1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getModeledTask__GetAllMeasument(), this.getMeasurement(), "getAllMeasument", 0, -1, !IS_UNIQUE, !IS_ORDERED);
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation
		  (getModeledTask__GetAllParameters(), 
		   source, 
		   new String[] {
