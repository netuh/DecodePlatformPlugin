 ...
 * </p>
 * <ul>
 *   <li>{@link be.edu.ufpe.ines.decode.measurement.TimeOnTask#getRelatedTask <em>Related Task</em>}</li>
 * </ul>
 *
 * @see be.edu.ufpe.ines.decode.measurement.MeasurementPackage#getTimeOnTask()
 * @model
 * @generated
 */
public interface TimeOnTask extends AbstractMeasurement {
	 ...
	 * @see be.edu.ufpe.ines.decode.measurement.MeasurementPackage#getTimeOnTask_RelatedTask()
	 * @model
	 * @generated
	 */
