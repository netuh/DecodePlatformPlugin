 ...
 * </p>
 * <ul>
 *   <li>{@link be.edu.ufpe.ines.decode.measurement.Measurements#getMeasurements <em>Measurements</em>}</li>
 * </ul>
 *
 * @see be.edu.ufpe.ines.decode.measurement.MeasurementPackage#getMeasurements()
 * @model
 * @generated
 */
public interface Measurements extends EObject {
	 ...
	 * The list contents are of type {@link be.edu.ufpe.ines.decode.measurement.AbstractMeasurement}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see be.edu.ufpe.ines.decode.measurement.MeasurementPackage#getMeasurements_Measurements()
