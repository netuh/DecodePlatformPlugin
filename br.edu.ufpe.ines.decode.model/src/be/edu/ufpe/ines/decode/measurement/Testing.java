 ...
 * </p>
 * <ul>
 *   <li>{@link be.edu.ufpe.ines.decode.measurement.Testing#getObservePassedTest <em>Observe Passed Test</em>}</li>
 * </ul>
 *
 * @see be.edu.ufpe.ines.decode.measurement.MeasurementPackage#getTesting()
 * @model
 * @generated
 */
public interface Testing extends Execution {
	 ...
	 * @see be.edu.ufpe.ines.decode.measurement.MeasurementPackage#getTesting_ObservePassedTest()
	...
	/**
	 * Sets the value of the '{@link be.edu.ufpe.ines.decode.measurement.Testing#getObservePassedTest <em>Observe Passed Test</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
