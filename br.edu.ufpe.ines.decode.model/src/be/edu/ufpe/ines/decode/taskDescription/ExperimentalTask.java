 ...
 * </p>
 * <ul>
 *   <li>{@link be.edu.ufpe.ines.decode.taskDescription.ExperimentalTask#getNewAttribute <em>New Attribute</em>}</li>
 *   <li>{@link be.edu.ufpe.ines.decode.taskDescription.ExperimentalTask#getRequiredArtifacts <em>Required Artifacts</em>}</li>
 *   <li>{@link be.edu.ufpe.ines.decode.taskDescription.ExperimentalTask#getDepends <em>Depends</em>}</li>
 * </ul>
 *
 * @see be.edu.ufpe.ines.decode.taskDescription.TaskDescriptionPackage#getExperimentalTask()
 * @model
 * @generated
 */
public interface ExperimentalTask extends ModeledTask, Nameable {
	 ...
	 * @see be.edu.ufpe.ines.decode.taskDescription.TaskDescriptionPackage#getExperimentalTask_NewAttribute()
	...
	/**
	 * Sets the value of the '{@link be.edu.ufpe.ines.decode.taskDescription.ExperimentalTask#getNewAttribute <em>New Attribute</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link be.edu.ufpe.ines.decode.artifacts.AbstractArtifact}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see be.edu.ufpe.ines.decode.taskDescription.TaskDescriptionPackage#getExperimentalTask_RequiredArtifacts()
	 * @model
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link be.edu.ufpe.ines.decode.taskDescription.ExperimentalTask}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see be.edu.ufpe.ines.decode.taskDescription.TaskDescriptionPackage#getExperimentalTask_Depends()
	 * @model
	 * @generated
	 */
