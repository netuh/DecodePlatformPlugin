...
public interface ArtifactsPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ABSTRACT_ARTIFACT__LOCAL_FILE_PATH = AuxPackage.NAMEABLE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int ATOMIC_ARTIFACT__LOCAL_FILE_PATH = ABSTRACT_ARTIFACT__LOCAL_FILE_PATH;
	 ...
	 * @ordered
	 */
	int COMPLEX_ARTIFACT__LOCAL_FILE_PATH = ABSTRACT_ARTIFACT__LOCAL_FILE_PATH;
	...
	/**
	 * Returns the meta object for the attribute '{@link be.edu.ufpe.ines.decode.artifacts.AbstractArtifact#getLocalFilePath <em>Local File Path</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Local File Path</em>'.
	 * @see be.edu.ufpe.ines.decode.artifacts.AbstractArtifact#getLocalFilePath()
	 * @see #getAbstractArtifact()
	 * @generated
	 */
	EAttribute getAbstractArtifact_LocalFilePath();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute ABSTRACT_ARTIFACT__LOCAL_FILE_PATH = eINSTANCE.getAbstractArtifact_LocalFilePath();
