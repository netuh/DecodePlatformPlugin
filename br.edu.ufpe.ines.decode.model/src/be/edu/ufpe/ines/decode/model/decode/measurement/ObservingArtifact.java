 ...
 * </p>
 * <ul>
 *   <li>{@link be.edu.ufpe.ines.decode.model.decode.measurement.ObservingArtifact#getAspect <em>Aspect</em>}</li>
 * </ul>
 *
 * @see be.edu.ufpe.ines.decode.model.decode.measurement.MeasurementPackage#getObservingArtifact()
 * @model abstract="true"
 * @generated
 */
public interface ObservingArtifact extends AbstractMeasurement {
	 ...
	 * @see be.edu.ufpe.ines.decode.model.decode.measurement.MeasurementPackage#getObservingArtifact_Aspect()
	...
	/**
	 * Sets the value of the '{@link be.edu.ufpe.ines.decode.model.decode.measurement.ObservingArtifact#getAspect <em>Aspect</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
