 ...
 *   <li>{@link be.edu.ufpe.ines.decode.model.decode.CodingExperiment#getProvidedArtefacts <em>Provided Artefacts</em>}</li>
 * </ul>
 *
...
public interface CodingExperiment extends Nameable {
	 ...
	 * @see be.edu.ufpe.ines.decode.model.decode.DecodePackage#getCodingExperiment_ProvidedArtefacts()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link be.edu.ufpe.ines.decode.model.decode.CodingExperiment#getProvidedArtefacts <em>Provided Artefacts</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
